...
class PatternTest extends StatefulWidget {
  const PatternTest({Key? key}) : super(key: key);
  static const routeName = "/pattern_test";

  @override
  _PatternsScreenState createState() => _PatternsScreenState();
}

class _PatternsScreenState extends State<PatternTest> {
